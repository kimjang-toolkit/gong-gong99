...
export default function Alert({ status, label }: AlertProps) {
  ...
  return (
    <div
      className="flex items-center bg-[#3F3F46] rounded-2xl px-3 py-2 whitespace-nowrap text-white typo-tiny-bold gap-2 absolute -translate-x-1/2 left-1/2 z-[50] top-16 shadow-sm
